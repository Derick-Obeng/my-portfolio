  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center">
      <div className="w-full px-4 py-8 sm:px-6 md:px-8 text-center"> {/* Added text-center here for ScrollingName */}
        ...
        <div className="max-w-2xl mx-auto mt-8 text-left p-8 rounded-2xl bg-gradient-to-br from-primary/10 via-secondary/5 to-transparent dark:from-primary/20 dark:via-secondary/10 dark:to-transparent">
